...
function draw() {
  ...
  for (let y = 0; y < height; y++) {
    for (let x = 0; x < width; x++) {
      ...
      let n00 = noiseGrid[gx1 + gy1 * gridSize];
      let n10 = noiseGrid[gx2 + gy1 * gridSize];
      let n01 = noiseGrid[gx1 + gy2 * gridSize];
      let n11 = noiseGrid[gx2 + gy2 * gridSize];
      
      let n = bilinearInterpolation(n00, n10, n01, n11, fx, fy);
